...
class Test(unittest.TestCase):
    ...
    def test_fs_reader(self):
        ...
        assert(fsclass.profiles[0].gen_data["baptism"].get_location()["county"] == "Valladolid")
        assert(fsclass.profiles[0].gen_data["death"].get_location()["place_name"] == "Calle De La Parrilla")
        ...
        assert(fsclass.profiles[2].gen_data["baptism"].get_location()["place_name"] == "Calle Nuestra Señora De Los Remedios")
        assert(fsclass.profiles[2].gen_data["death"].get_location()["county"] == "Valladolid")
        ...
        assert(fsclass.profiles[4].gen_data["baptism"].get_location()["county"] == "Valladolid")
        assert(fsclass.profiles[4].gen_data["death"].get_location()["place_name"] == "Calle De La Parrilla")
    ...
    def test_fs_reader_single_person(self):
        ...
        assert(this_profile.gen_data["death"].get_location()["place_name"] == 'Calle De La Parrilla')
        assert(this_profile.gen_data["birth"].get_location()["place_name"] == 'Calle De La Parrilla')
